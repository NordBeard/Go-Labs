...
// filter применяет преобразование к изображению (в оттенки серого)
...
func main() {
	...
	inputFile, err := os.Open("C:/For study/Python Projects/5_lab/1_task/2_task/7a941b62e881e1174c6213982305a636.png")
	if err != nil {
	...
	// Преобразование к *image.RGBA, если это необходимо
	...
	outputFile, err := os.Create("C:/photolab/2.png")
	if err != nil {
